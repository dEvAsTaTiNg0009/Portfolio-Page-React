    ...
    <div className="home-container10">
      ...
      <div className="home-container12">
        <div className="home-hero">
          <div className="home-hero-text-container">
            <h1 className="home-heading3 Section-Heading">
            ...
            <div className="home-cta-btn-container">
              <button className="home-cta-btn1 Anchor button">
                <span className="home-text12">MY WORK</span>
              </button>
              <button className="home-cta-btn2 button Anchor">ABOUT ME</button>
            </div>
          </div>
          <img
            alt="image"
      ...
      <div className="home-features">
        <div className="home-heading-container1">
          <h2 className="home-text13 Section-Heading">Deliverables</h2>
        ...
        <div className="home-cards-container">
          <div className="home-card1">
            ...
            <div className="home-content-container1">
              <span className="home-heading4 Card-Heading">Diagrams</span>
          ...
          <div className="home-card2">
            ...
            <div className="home-content-container2">
              <span className="home-heading5 Card-Heading">Wireframes</span>
          ...
          <div className="home-card3">
            ...
            <div className="home-content-container3">
              <span className="home-heading6 Card-Heading">Design</span>
      ...
      <div className="home-about">
        <div className="home-max-content-width-container">
          ...
          <button className="home-button1 Anchor button">CHECK MY WORK</button>
        </div>
      </div>
      <div className="home-section-separator3"></div>
      <div className="home-clients">
        <div className="home-heading-container3">
          <h1 className="home-text28 Section-Heading">Clients</h1>
        ...
        <div className="home-logo-container">
          ...
          <img alt="image" src="/default-img.svg" className="home-logo5" />
        </div>
      </div>
      <div className="home-pricing">
        <div className="home-heading-container4">
          <h1 className="home-text30 Section-Heading">Ask for a quote</h1>
        ...
        <div className="home-pricing-card-container">
          <div className="home-card4">
            <div className="home-card-heading1">
              <span className="home-type1 Anchor">Minimal</span>
            ...
            <div className="home-card-content1">
              ...
              <div className="home-feature2">
                ...
                <span className="home-limit2 Card-Text">TBD</span>
              </div>
              ...
              <div className="home-feature4">
                ...
                <span className="home-limit4 Card-Text">UNLIMITED</span>
              </div>
          ...
          <div className="home-card5">
            <div className="home-card-heading2">
              <span className="home-type2 Anchor">medium</span>
            ...
            <div className="home-card-content2">
              ...
              <div className="home-container20">
                <span className="Card-Text">Feature two</span>
                <span className="home-text35 Card-Text">TBD</span>
              </div>
              ...
              <div className="home-container22">
                <span className="Card-Text">Feature four</span>
                <span className="home-text39 Card-Text">UNLIMITED</span>
              </div>
          ...
          <div className="home-card6">
            <div className="home-card-heading3">
              <span className="home-type3 Anchor">Premium</span>
              <span className="Section-Heading">Professional</span>
            </div>
            <div className="home-card-content3">
              <div className="home-container23">
                <span className="Card-Text">Feature one</span>
                <span className="home-text41 Card-Text">TBD</span>
              </div>
              <div className="home-container24">
                <span className="Card-Text">Feature two</span>
                <span className="home-text43 Card-Text">TBD</span>
              </div>
              <div className="home-container25">
                <span className="Card-Text">Feature three</span>
                <span className="home-text45 Card-Text">UNLIMITED</span>
              </div>
              <div className="home-container26">
                <span className="Card-Text">Feature four</span>
                <span className="home-text47 Card-Text">UNLIMITED</span>
              </div>
      ...
      <div className="home-subscribe">
        ...
        <div className="home-container27">
          <div className="home-heading-container5">
            <h1 className="home-text49 Section-Heading">
